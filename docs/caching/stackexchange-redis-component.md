...
In your app host project, register the .NET Aspire Stack Exchange Redis component using the <xref:Aspire.Hosting.RedisBuilderExtensions.AddRedis%2A> and consume the service using the following methods:
