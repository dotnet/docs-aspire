...
1. Get the instance of the provisioning resource type in question, for example:
    ...
    - Azure Web PubSub: <xref:Azure.Provisioning.WebPubSub.WebPubSubService.IsLocalAuthDisabled?displayProperty=fullName>. For more information on configuring infra, see [Customize provisioning infrastructure](https://aspire.dev/integrations/azure-web-pubsub/).
