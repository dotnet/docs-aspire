...
1. Looking for the project with the `Aspire.AppHost` package reference in its `.csproj` file
1. Finding the directory containing the _azure.yaml_ file
1. Locating the project referenced in your solution that orchestrates other services
