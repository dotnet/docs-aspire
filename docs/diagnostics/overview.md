...
| [`ASPIRE003`](aspire003.md) | Warning | <span id="ASPIRE003"></span> 'Project' is an Aspire AppHost project that requires Visual Studio version 17.10 or above to work correctly. |
