...
For the remainder of this article, imagine that you're exploring a `Program` class in an Aspire [AppHost project](https://aspire.dev/get-started/app-host/) that's already defined the distributed app builder bits:
