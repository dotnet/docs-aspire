...
| - **Learn More**: [📄 Ollama](../community-toolkit/ollama-hosting.md) <br /> - **Hosting**: [📦 Aspire.CommunityToolkit.Hosting.Ollama](https://www.nuget.org/packages/Aspire.CommunityToolkit.Hosting.Ollama) <br /> - **Client**: N/A | An Aspire component leveraging the [Ollama](https://ollama.com) container with support for downloading a model on startup. |
<!-- markdownlint-enable MD033 MD045 -->
