...
If you need to configure your own local database, you can refer to the [SQL Server integration](xref:dotnet/aspire/database/sql-server-integration.md) documentation.
