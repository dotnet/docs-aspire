---
title: Upgrade to .NET Aspire 9.4
description: Learn how to upgrade all your .NET Aspire projects to .NET Aspire 9.4.
ms.date: 06/02/2025
...
In this article, you learn the steps involved in updating your existing .NET Aspire projects to the latest version: .NET Aspire 9.4. There are a few ways in which you can update your projects to .NET Aspire 9.4:

- Manually upgrade your projects to .NET Aspire 9.4.
- Use the **Upgrade Assistant** to upgrade your projects to .NET Aspire 9.4.
...
Before you upgrade your projects to .NET Aspire 9.4, ensure that you have the following prerequisites:
...
## Manually upgrade a solution to .NET Aspire 9.4

To upgrade your projects to .NET Aspire 9.4, you need to update your project files. The following steps guide you through the process:

- Edit your [AppHost](xref:dotnet/aspire/app-host) project file to use the new .NET Aspire 9.4 SDK (`Aspire.AppHost.Sdk`).
...
To upgrade your AppHost project to .NET Aspire 9.4, you need to update your project file to use the new [📦 Aspire.AppHost.Sdk](https://www.nuget.org/packages/Aspire.AppHost.Sdk):
...
.NET Aspire 9.4 runs on .NET 9.0, but you can also run it on .NET 8.0. In other words, just because you're using the .NET Aspire SDK, and pointing to version 9.4 packages, you can still target .NET 8.0. If you want to run your .NET Aspire 9.4 project on .NET 9.0, you need to update the `TargetFramework` property in your project file:
...
For the complete list of breaking changes in .NET Aspire 9.4, see [Breaking changes in .NET Aspire 9.4](../compatibility/9.4/index.md).
...
Regardless of how you install the Upgrade Assistant, you can use it to upgrade your .NET Aspire projects to .NET Aspire 9.4.

:::zone pivot="visual-studio"

To upgrade the .NET Aspire AppHost project to .NET Aspire 9.0 with Visual Studio, right-click the project in **Solution Explorer** and select **Upgrade**.
...
To update your AppHost project, use the following .NET CLI command to update the `Aspire.Hosting.AppHost` package to version `9.0.0`:
