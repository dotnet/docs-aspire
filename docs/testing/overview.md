...
The testing builder disables the [Aspire dashboard](https://aspire.dev/dashboard/overview/) by default. To enable it, you can set the `DisableDashboard` property to `false`, when creating your testing builder as shown in the following snippet:
