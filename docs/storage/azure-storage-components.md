...
Add the [.NET Aspire Azure Blob Storage component](azure-storage-blobs-component.md) and [.NET Aspire Azure Queue Storage component](azure-storage-queues-component.md) packages to your _AspireStorage.Web_ project:
...
Your **AspireStorage.Web** project is now set up to use .NET Aspire components. Here's the updated _AspireStorage.Web.csproj_ file:
...
The worker service handles pulling messages off of the Azure Storage queue for processing. Add the [.NET Aspire Azure Queue Storage component](azure-storage-queues-component.md) component package to your _AspireStorage.WorkerService_ app:
